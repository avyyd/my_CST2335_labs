    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `ShoppingItem` (`id` INTEGER NOT NULL, `quantity` INTEGER NOT NULL, `name` TEXT NOT NULL, PRIMARY KEY (`id`))');
...
class _$ShoppingItemDAO extends ShoppingItemDAO {
  ...
  @override
  Future<void> updateItem(ShoppingItem newItem) async {
    await _shoppingItemUpdateAdapter.update(newItem, OnConflictStrategy.abort);
  }
